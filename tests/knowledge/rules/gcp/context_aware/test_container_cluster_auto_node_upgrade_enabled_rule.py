...
class TestContainerClusterAutoNodeUpgradeEnabledRule(TestCase):
    def setUp(self):
        self.rule = ContainerClusterAutoNodeUpgradeEnabledRule()
    ...
    def test_container_cluster_auto_node_upgrade(self, unused_name: str, auto_upgrade: bool, total_issues: int, rule_status: RuleResultType):
        # Arrange
        ...
        management.auto_upgrade = auto_upgrade
