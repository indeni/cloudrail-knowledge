...
class TestFunctionApp(AzureContextTest):
    ...
    @context(module_path="linux_fx_version/full_linux_fx_version", test_options=TestOptions(run_drift_detection=False))
    ...
    @context(module_path="linux_fx_version/no_linux_fx_version", test_options=TestOptions(run_drift_detection=False))
