...
class TestDmsReplicationInstance(AwsContextTest):
    ...
    @context(module_path="default_vpc_public_access", base_scanner_data_for_iac='account-data-dms-instance-networking-public.zip', test_options=TestOptions(run_cloudmapper=False,run_terraform=False))
