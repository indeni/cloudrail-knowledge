...
class TestCodeBuildReportGroup(AwsContextTest):
    ...
    def test_encrypted_at_rest_with_aws_managed_key_by_key_arn(self, ctx: AwsEnvironmentContext):
        ...
        self.assertEqual(report_group.server_name, 'codebuild-report-group-non-kms-cmk-encrypted')
    ...
    def test_basic_with_tags(self, ctx: AwsEnvironmentContext):
        group = next((group for group in ctx.codebuild_report_groups if group.server_name == 'codebuild-report-group-non-kms-cmk-encrypted'), None)
