...
class TestInvalidation(AwsContextTest):
    ...
    @context(module_path="tf_test_missing_vpc_and_sg", test_options=TestOptions(run_cloudmapper=False))
    ...
    @context(module_path="missing_default_vpc", test_options=TestOptions(run_cloudmapper=False),
