...
from cloudrail.knowledge.context.gcp.resources.cluster.gcp_container_cluster import WorkloadMetadataConfigMode
...
class ContainerClusterMetadataServerEnabledRule(GcpBaseRule):
    ...
    def execute(self, env_context: GcpEnvironmentContext, parameters: Dict[ParameterType, any]) -> List[Issue]:
        ...
        for container_cluster in env_context.container_cluster:
            if container_cluster.workload_metadata_config.mode != WorkloadMetadataConfigMode.GKE_METADATA:
                issues.append(
                    Issue(
