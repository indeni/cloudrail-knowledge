...
class AwsRelationsAssigner(DependencyInvocation):
    ...
    def __init__(self, ctx: AwsEnvironmentContext):
        ...
        function_pool = [
            ...
            IterFunctionData(self._assign_default_network_acl_rules, [nacl for nacl in ctx.network_acls if nacl.is_managed_by_iac],
                             (ctx.vpcs,)),
    ...
    def _assign_rds_instance_missing_data_from_cluster(rds_instance: RdsInstance, rds_clusters: List[RdsCluster]):
        ...
        if rds_cluster:
            ...
            if rds_cluster.origin == EntityOrigin.CLOUDFORMATION and \
                rds_cluster.engine_type.lower().startswith('aurora') and \
                rds_instance.publicly_accessible is None:
